...
valkey_module! {
    ...
    commands: [
        ...
        ["argrep", commands::argrep, "readonly", 1, 1, 1, "read array"],
        ...
        ["arlastitems", commands::arlastitems, "readonly", 1, 1, 1, "read array"],
        ...
        ["arop", commands::arop, "readonly", 1, 1, 1, "read array"],
        ["arring", commands::arring, "write fast deny-oom", 1, 1, 1, "write fast array"],
        ["arscan", commands::arscan, "readonly", 1, 1, 1, "read array"],
